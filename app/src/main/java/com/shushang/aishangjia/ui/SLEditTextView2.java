...
public class SLEditTextView2 extends AppCompatEditText implements View.OnFocusChangeListener,TextWatcher {
    ...
    public SLEditTextView2(Context context) {
        super(context);
        init(context);
    }

    public SLEditTextView2(Context context, AttributeSet attrs){
        super(context,attrs);
        init(context);
    }

    public SLEditTextView2(Context context, AttributeSet attrs, int defStyleAttr){

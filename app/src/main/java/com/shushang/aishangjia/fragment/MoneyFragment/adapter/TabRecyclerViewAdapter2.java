...
public class TabRecyclerViewAdapter2 extends BaseQuickAdapter<TabList.DataListBean,BaseViewHolder> {
    ...
    public TabRecyclerViewAdapter2(@LayoutRes int layoutResId, @Nullable List<TabList.DataListBean> data) {
